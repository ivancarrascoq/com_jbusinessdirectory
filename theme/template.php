...
<div id="jdb-wrapper" class="jdb-wrapper-front">
	<?php if($this->_name!="useroptions"){ ?>
    	<div id="menu-button" class="menu-button btn-primary">
    		<i class="dir-icon-bars"></i> <?php echo JText::_("LNG_SHOW_MENU") ?>
    	</div>
	<?php } ?>
	<nav class="navbar-default navbar-static-side <?php echo $this->_name!="useroptions"?"closed":""?>" role="navigation" id="dir-navigation">
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
				<li class="nav-header">
					<div class="navbar-minimalize minimalize-styl-2"><i class="dir-icon-bars"></i></div>
					<div class="user-info">
...
jQuery(document).ready(function () {
    ...
    jQuery("#menu-button").click(function(){
     	...
     	if (jQuery('#side-menu').height()<10){
     		jQuery(this).html("<?php echo "<i class='dir-icon-bars'></i> ".JText::_("LNG_HIDE_MENU")?>");
     	}else{
     		jQuery(this).html("<?php echo "<i class='dir-icon-bars'></i> ".JText::_("LNG_SHOW_MENU")?>");
     	}
    });
});
