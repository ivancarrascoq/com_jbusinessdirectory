	...
	<table class="table responsive">
		...
		<tbody>
			...
			if($this->item->discount_amount>0){
				...
				echo '<td style="white-space:nowrap" data-title="'.JText::_('LNG_QUANTITY').'" >'.$this->item->discount_amount.' '.$this->appSettings->currency_name.'</td>';
				echo '</tr>';
			}
			?>
			<tr>
				...
				<td style="white-space:nowrap" data-title="<?php echo JText::_('LNG_SUB_TOTAL'); ?>"><?php echo JBusinessUtil::getPriceFormat($this->item->initial_amount- $this->item->discount_amount) ?></td>
			</tr>
			...
			<?php if(!empty($this->item->vat_amount) && $this->item->vat_amount>0){ ?>
				<tr>
					...
					<td style="white-space:nowrap" data-title="<?php echo JText::_('LNG_VAT'); ?>"><?php echo JBusinessUtil::getPriceFormat($this->item->vat_amount)?></td>
				</tr>
			<?php } ?>
			<?php if(!empty($this->item->taxes)) { ?>
				<?php foreach ($this->item->taxes as $tax) { ?>
					<tr>
						...
						<td style="white-space:nowrap" data-title="<?php echo $tax->tax_name ?> <?php echo $tax->tax_type==2?"(".$tax->percentage."%)":""?>"><?php echo JBusinessUtil::getPriceFormat($tax->tax_amount) ?></td>
					</tr>
				<?php } ?>
			<?php } ?>
			<tr>
				...
				<td style="white-space:nowrap" data-title="<?php echo JText::_('LNG_TOTAL'); ?>"><?php echo JBusinessUtil::getPriceFormat($this->item->amount)?></td>
			</tr>
		</tbody>
	</table>
