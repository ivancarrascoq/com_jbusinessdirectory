			...
			<form action="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&task=businessuser.addUser'); ?>" method="post" name="registration-form" id="registration-form" >
				<fieldset>
					...
					<div class="form-item">
						...
						<div class="outer_input">
							<input type="text" name="email1" id="email1" size="50" class="validate[required,custom[email]]"><br>
						</div>
					</div>
						<div class="form-item">
						<label for="email"><?php echo JText::_('LNG_CONFIRM_EMAIL') ?></label>
						<div class="outer_input">
							<input type="text" name="email2" id="email2" size="50" class="validate[required,custom[email]]"><br>
						</div>
					</div>
					<div class="form-item">
						<label for="password"><?php echo JText::_('LNG_PASSWORD') ?></label>
						<div class="outer_input">
							<input type="password" name="password1" id="password1" size="50" class="validate[required]"><br>
						</div>
					</div>
					<div class="form-item">
						<label for="passwordc"><?php echo JText::_('LNG_CONFIRM_PASSWORD') ?></label>
						<div class="outer_input">
							<input type="password" name="password2" id="password2" size="50" class="validate[required]"><br>
						</div>
					</div>
