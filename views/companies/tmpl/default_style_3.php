                    ...
                    <div class="company-info-average-rating">
                        ...
                        <?php if($appSettings->enable_reviews) { ?>
                            <p class="review-count">
                                <?php if(!empty($this->reviews)){ ?>
                                    <a href="<?php echo $url?>#reviews"><?php echo count($this->reviews)?> <?php echo JText::_('LNG_REVIEWS') ?></a>
                                    &nbsp;|&nbsp;
			...
			<div class="company-links">
				<ul class="features-links">
					<?php if($showData && (isset($this->package->features) && in_array(WEBSITE_ADDRESS,$this->package->features) || !$appSettings->enable_packages) && !empty($company->website)){
						...
						<li>
							<a <?php echo $followLink ?> target="_blank" itemprop="url" class="website" title="<?php echo $this->escape($this->company->name) ?> Website" onclick="registerAction(<?php echo $company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)" href="<?php echo $this->escape($company->website) ?>"><?php echo JText::_('LNG_WEBSITE') ?></a>
						</li>
                    <?php } ?>
					<?php
			...
			<div class="span3">
				<div>
        			...
        			<?php if($appSettings->enable_reporting){?>
        				 <div class="report-listing"><a href="javascript:showReportAbuse()"><?php echo JText::_('LNG_REPORT_LISTING'); ?></a></div>
        			<?php } ?>
        			<div class="clear"></div>
				</div>
				...
				?>		
					<a href="javascript:showCompanyMap()" title="Show Map">
						<?php if((isset($this->package->features) && in_array(GOOGLE_MAP,$this->package->features) || !$appSettings->enable_packages) && !empty($this->company->latitude) && !empty($this->company->longitude)) {
							echo JBusinessUtil::getStaticMap($this->company->latitude, $this->company->longitude, null, 300, 150);
						} ?>
					</a> 	
					<div class="clear"></div>
				<?php } ?>
