...
<div id="company-style-7-container" itemscope itemtype="http://schema.org/LocalBusiness">
    <div class="dir-print">
        <a href="javascript:printCompany('<?php echo JRoute::_("index.php?option=com_jbusinessdirectory&view=companies&tmpl=component&layout=print&companyId=".$this->company->id); ?>')"><i class="dir-icon-print"></i> <?php echo JText::_("LNG_PRINT")?></a>
    </div>
		...
		<div class="row-fluid">
			...
			<div class="company-style-7-header-image span12">
				<div class="company-style-7-header-info row-fluid">
					<div class="span9 first-column">
						<?php if(isset($this->package->features) && in_array(SHOW_COMPANY_LOGO,$this->package->features) || !$appSettings->enable_packages){ ?>
                            <span itemprop="image" style="display:none;"><?php echo (isset($this->company->logoLocation) && $this->company->logoLocation!='') ? JURI::root().PICTURES_PATH.$this->company->logoLocation : JURI::base() ."components/".JBusinessUtil::getComponentName().'/assets/no_image.jpg' ?></span>
					...
					<div class="span3 second-column">
						...
						<?php if($appSettings->enable_reviews){ ?>
							<div class="span12 clear">
								<!-- Business Add Review -->
								<a href="<?php echo $url?>#go-company-reviews" onclick="showReviewForm(<?php echo ($appSettings->enable_reviews_users && $user->id ==0)?"1":"0"; ?>)" class="ui-dir-button ui-dir-button-blue">
				...
				<div class="company-style-7-header-menu">
    				<ul class="menu">
    					<li>
            				<a id="business-link" href="<?php echo $url?>#company-style-7-body" class="active"><?php echo JText::_("LNG_PROFILE")?></a>
            			</li>
            			<?php 
            			...
            			?>	<li>
            					<a id="gallery-link" href="<?php echo $url?>#image-gallery" class=""><?php echo JText::_("LNG_GALLERY")?></a>
            				</li>
            			<?php } ?>
            			<?php 
        		      	...
        		      	?>	
        		      			<li>
            						<a id="events-link" href="<?php echo $url?>#company-events" class=""><?php echo JText::_("LNG_EVENTS")?></a>
            					</li>
            			<?php } ?>
        			</ul>
    			</div>
    					...
    					<h3><?php echo JText::_("LNG_BUSINESS_DETAILS")?></h3>
							...
							<div class="company-links">
								<?php if($showData && (isset($this->package->features) && in_array(WEBSITE_ADDRESS, $this->package->features) || !$appSettings->enable_packages) && !empty($company->website)) {
									...
									<a <?php echo $followLink ?> itemprop="url" class="website" title="<?php echo $this->escape($this->company->name) ?> Website" target="_blank" onclick="registerAction(<?php echo $company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)" href="<?php echo $this->escape($company->website) ?>">
