						...
						<div class="rating-container">
							...
							<div class="review-info">
								<?php if($appSettings->enable_reviews) { ?> 
									<a href="<?php echo $url?>#go-company-reviews"><span><?php echo count($this->reviews); ?> <?php echo JText::_('LNG_REVIEWS'); ?></span></a>
								<?php } ?>
							</div>
							<div class="clear"></div>
						</div>
    				...
    				<?php }?>
    				 ...
    				 <?php if($showData && (isset($this->package->features) && in_array(WEBSITE_ADDRESS, $this->package->features) || !$appSettings->enable_packages) && !empty($company->website)) {
                            ...
                            <span class="nowrap">
                                ...
                                <a <?php echo $followLink ?> itemprop="url" class="website" title="<?php echo $this->escape($this->company->name) ?> Website" target="_blank" onclick="registerAction(<?php echo $company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)" href="<?php echo $company->website ?>">
                        ...
                        <div class="span12">
                            ...
                            <?php if($showData && (isset($this->package->features) && in_array(PHONE, $this->package->features) || !$appSettings->enable_packages)) { ?>
                                ...
                                <?php if(!empty($this->company->mobile)) { ?>
                                    <div class="phone" itemprop="telephone">
	                                    <i class="dir-icon-mobile-phone dir-icon-large dir-icon-sized"></i><a href="tel:<?php  echo $this->escape($this->company->mobile); ?>" style="color:black;"><?php  echo $this->company->mobile; ?></a>
                                    </div>
                                <?php } ?>
