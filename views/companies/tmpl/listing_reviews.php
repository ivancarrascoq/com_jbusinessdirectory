...
<a class="add-review-link" href="javascript:void(0)" onclick="showReviewForm(<?php echo ($appSettings->enable_reviews_users && $user->id ==0)?"1":"0"; ?>);event.stopPropagation();"><?php echo JText::_("LNG_ADD_REVIEW") ?></a>
<div class="clear"></div>
<?php

if(!$appSettings->enable_reviews_users || !$user->id ==0) {
    require_once 'default_addreview.php';
}
		...
		<li class="review">
			<div class="review-content">
				...
				<div class="review-description" itemprop="description">
					<pre class="review-text"><?php echo $this->escape($review->description) ?></pre>
				</div>
				...
				<div class="review-actions">
					<ul>
						<li class="first">
							<a href="javascript:reportReviewAbuse(<?php echo ($appSettings->enable_reviews_users && $user->id ==0)?"1":"0"; ?>,'<?php echo $review->id?>')"><?php echo JText::_('LNG_REPORT_ABUSE') ?></a>
						</li>
						<li>
							<a href="javascript:respondToReview(<?php echo ($appSettings->enable_reviews_users && $user->id ==0)?"1":"0"; ?>,'<?php echo $review->id?>')"><?php echo JText::_('LNG_RESPOND_TO_REVIEW') ?></a>
						</li>
					</ul>
				</div>
