								...
								<div class="review-info">
									<?php if($appSettings->enable_reviews) {
                                        if(GET_DATA_FROM_YELP) {
                                            ...
                                            $totalReview = count($this->reviews);
                                        }
									    ?>
					...
					<div class="span3 second-column">
						...
						<?php if($appSettings->enable_reviews){ ?>
							<div class="span12 clear">
								<!-- Business Add Review -->
								<a href="<?php echo $url?>#reviews" onclick="showReviewForm(<?php echo ($appSettings->enable_reviews_users && $user->id ==0)?"1":"0"; ?>);event.stopPropagation();" class="ui-dir-button ui-dir-button-blue">
			...
			<div class="span8">
				...
				<?php if((isset($this->package->features) && in_array(SOUNDS_FEATURE,$this->package->features) || !$appSettings->enable_packages)
					...
					<div class="company-style-box">
						<div class="row-fluid">
							<div class="span12">
								<h3><i class="fa dir-icon-soundcloud"></i> <?php echo JText::_("LNG_SOUNDS")?></h3>
			...
			<div class="span4">
				...
				<?php if(!empty($this->companyArticles) && file_exists(JPATH_SITE.'/plugins/content/business/business.php')) { ?>
					<div class="company-style-box">
						<div class="row-fluid">
							<div class="span12">
								<h3><i class="fa dir-icon-newspaper-o"></i> <?php echo JText::_("LNG_LISTING_ARTICLES"); ?></h3>
