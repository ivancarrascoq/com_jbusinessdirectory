                                                ...
                                                <?php if ($counterAreas < $this->appSettings->search_filter_items) { ?>
                                                    <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                                        <div <?php if ($selected) echo 'class="selected"'; ?>>
                                                            <a href="javascript:void(0)"
                                                               onclick="<?php echo $selected ? "removeFilterRule('area', &quot;" . $this->escape($filterCriteria->areaName) . "&quot;, ".$setCategory.", ".$categId."  )" : "addFilterRule('area', &quot;" . $this->escape($filterCriteria->areaName) . "&quot;, ".$setCategory.", ".$categId."  )"; ?>"><?php echo $filterCriteria->areaName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
                                                        </div>
                                                    </li>
                                                    <?php $counterAreas++;
                                                } else { ?>
                                                ...
                                                <?php if ($counterCities < $this->appSettings->search_filter_items) { ?>
                                                    <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                                        <div <?php if ($selected) echo 'class="selected"'; ?> class="selectedlink">
                                                            <a href="javascript:void(0)"
                                                               onclick="<?php echo $selected ? "removeFilterRule('city', &quot;" . $this->escape($filterCriteria->cityName) . "&quot;, ".$setCategory.", ".$categId."  )" : "addFilterRule('city', &quot;" . $this->escape($filterCriteria->cityName) . "&quot;, ".$setCategory.", ".$categId."  )"; ?>"><?php echo $filterCriteria->cityName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
                                                        </div>
                                                    </li>
                                                    <?php $counterCities++;
                                                } else { ?>
                                            ...
                                            foreach ($this->searchFilter["regions"] as $filterCriteria) { ?>
                                                ...
                                                <?php if ($counterRegions < $this->appSettings->search_filter_items) { ?>
                                                    ...
                                                    <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                                        <div <?php if ($selected) echo 'class="selected"'; ?>>
                                                            <a href="javascript:void(0)"
                                                               onclick="<?php echo $selected ? "removeFilterRule('region', &quot;" . $this->escape($filterCriteria->regionName) . "&quot;, ".$setCategory.", ".$categId."  )" : "addFilterRule('region', &quot;" . $this->escape($filterCriteria->regionName) . "&quot;, ".$setCategory.", ".$categId." )"; ?>"><?php echo $filterCriteria->regionName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
                                                        </div>
                                                    </li>
                                                    <?php $counterRegions++;
                                                } else { ?>
					...
					<div id="search-path">
        				...
        				<ul class="selected-criteria">
                            ...
                            <?php if(!empty($this->regionSearch) && empty($this->searchFilter["regions"])) { ?>
                                <li>
                                    <a class="filter-type-elem"
                                       onclick="removeSearchRule('region')"><?php echo $this->regionSearch; ?> x</a>
                                </li>
                                <?php $showClear++;
                            } ?>
                            ...
                            <?php if(!empty($this->citySearch) && empty($this->searchFilter["cities"])) { ?>
                                <li>
                                    <a class="filter-type-elem"
                                       onclick="removeSearchRule('city')"><?php echo $this->citySearch; ?> x</a>
                                </li>
                                <?php $showClear++;
                            } ?>
        					...
        					<?php if(!empty($this->selectedParams["area"]) && !empty( $this->searchFilter["areas"])) { ?>
                                <li>
                                    <a class="filter-type-elem" class="remove"
                                       onclick="removeFilterRule('area', <?php echo "&quot;" . $this->selectedParams["area"][0] . "&quot;" ?>)"> <?php echo $this->searchFilter["areas"][$this->selectedParams["area"][0]]->areaName; ?> x</a>
                                </li>
                                <?php $showClear++;
                            } ?>
                            ...
                            <?php if(!empty($this->minPrice)) { ?>
                                <li>
                                    <a class="filter-type-elem"
                                       onclick="removeSearchRule('minprice')"><?php echo "Min Price: ". $this->minPrice; ?> x</a>
                                </li>
                                <?php $showClear++;
                            } ?>

                            <?php if(!empty($this->maxPrice)) { ?>
                                <li>
                                    <a class="filter-type-elem"
                                       onclick="removeSearchRule('maxprice')"><?php echo "Max Price: ". $this->maxPrice; ?> x</a>
                                </li>
                                <?php $showClear++;
                            } ?>
                ...
                <div class="clear"></div>
					...
					<div class="search-options">
						...
						<?php if($this->appSettings->show_search_map && !empty($this->offers)){?>
							<div class="search-options-item view-mode shadow-input">
								<a id="map-link" class="map <?php echo $this->appSettings->map_auto_show != 1 ? 'active' : '' ?>" title="Grid" href="javascript:showMap(true)"><?php echo JText::_("LNG_SHOW_MAP")?></a>
							</div>
						<?php } ?>
