...
<div id="event-container" class="event-container row-fluid" itemscope itemtype="http://schema.org/Event">
    ...
    <div class="row-fluid">
        ...
        <div id="event-content" class="event-content span6">
            <div class="dir-print">
            	<a href="javascript:printEvent('<?php echo JRoute::_("index.php?option=com_jbusinessdirectory&view=event&tmpl=component&action=print&eventId=".$this->event->id); ?>')"><i class="dir-icon-print"></i> <?php echo JText::_("LNG_PRINT")?></a>
	    	</div>
            <h1 itemprop="name">
	                ...
	                <table>
	                   ...
	                   <?php if(!empty($this->event->company->phone) || !empty($this->event->company->mobile)){?>
	                    ...
	                    <?php if(!empty($this->event->company->website)){?>
	                        <tr>
	                        	<td>
	                            	<a target="_blank" itemprop="url" title="<?php echo $this->escape($this->event->company->name)?> Website" onclick="registerAction(<?php echo $this->event->company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)" href="<?php echo $this->escape($this->event->company->website) ?>"><i class="dir-icon-link "></i>  <?php echo JText::_('LNG_WEBSITE')?></a></a>
	                            </td>
	                        </tr>
	                    <?php } ?>
	                </table>
