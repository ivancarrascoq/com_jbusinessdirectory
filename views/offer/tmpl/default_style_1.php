    ...
    <div id="offer-container" class="offer-container row-fluid">
        ...
        <div id="offer-content" class="offer-content span6">
            <div class="dir-offer-links">
            	<div class="link-item">
            		<a href="javascript:printOffer('<?php echo JRoute::_("index.php?option=com_jbusinessdirectory&view=offer&tmpl=component&action=print&offerId=".$this->offer->id); ?>')"><i class="dir-icon-print"></i> <?php echo JText::_("LNG_PRINT")?></a>
	            ...
	            <div class="company-details" itemprop="offeredBy" itemscope itemtype="http://schema.org/Organization">
	                <table>
	                    ...
	                    <?php if(!empty($this->offer->company->website)){?>
	                        <tr>
	                            <td itemprop="url">
	                            	<a target="_blank" itemprop="url" title="<?php echo $this->escape($this->offer->company->name)?> Website" onclick="registerAction(<?php echo $this->offer->company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)" href="<?php echo $this->escape($this->offer->company->website) ?>"><i class="dir-icon-link "></i> <?php echo JText::_('LNG_WEBSITE') ?></a>
	                            </td>
	                        </tr>
	                    <?php } ?>
