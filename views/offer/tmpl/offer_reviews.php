...
<a class="add-review-link" href="javascript:void(0)" onclick="addNewReview(<?php echo ($appSettings->enable_reviews_users && $user->id ==0) ?"1":"0"?>,false)"><?php echo JText::_("LNG_ADD_REVIEW") ?></a>
