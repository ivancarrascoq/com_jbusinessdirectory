				...
				if(!empty($this->items)){
					foreach($this->items as $event) { ?>
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td data-title="<?php echo JText::_('LNG_START_DATE'); ?>" class="has-title">
								<?php echo JBusinessUtil::getDateGeneralFormat($event->start_date) ?>
							</td>
							<td data-title="<?php echo JText::_('LNG_END_DATE'); ?>" class="has-title">
								<?php echo JBusinessUtil::getDateGeneralFormat($event->end_date) ?>
							</td>
							<td data-title="<?php echo JText::_('LNG_VIEW_NUMBER'); ?>" class="has-title">
