                                    ...
                                    <div class="info">
                                        <div class="hover_info">
                                            ...
                                            <?php if($showData && !empty($company->website) && (isset($company->packageFeatures) && in_array(WEBSITE_ADDRESS,$company->packageFeatures) || !$enablePackages)){
                                                ...
                                                <div>
                                                    <a <?php echo $followLink ?> target="_blank" class="company-website" title="<?php echo $this->escape($company->name)?>" target="_blank" onclick="registerAction(<?php echo $company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)" href="<?php echo $this->escape($company->website) ?>"><i class="dir-icon-globe"></i> <?php echo $this->escape($company->website) ?></a>
                                                </div>
                                            <?php } ?>
