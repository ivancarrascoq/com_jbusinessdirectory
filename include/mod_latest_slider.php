                            ...
                            <div class="hover_info">
                                ...
                                <?php if($showData && !empty($item->website) && (isset($item->packageFeatures) && in_array(WEBSITE_ADDRESS,$item->packageFeatures) || !$enablePackages)){
                                    ...
                                    <div onclick="this.event.stopPropagation()">
                                        <a <?php echo $followLink ?> target="_blank" itemprop="url" title="<?php echo $db->escape($item->name);?> Website" onclick="registerAction(<?php echo $item->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>);event.stopPropagation();" href="<?php echo $db->escape($item->website) ?>"><i class="dir-icon-globe"></i> <?php echo $db->escape($item->website) ?></a>
                                    </div>
                                <?php } ?>
