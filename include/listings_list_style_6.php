                                        ...
                                        <div class="item-info-wrap">
                                            <?php if($showData && !empty($company->website) && (isset($company->packageFeatures) && in_array(WEBSITE_ADDRESS,$company->packageFeatures) || !$enablePackages)){
                                                ...
                                                <div class="item-info truncate-text">
                                                    <i class="dir-icon-home"></i><a rel="<?php echo $followLink ?>" onclick="registerAction(<?php echo $company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)" href="<?php echo $this->escape($company->website) ?>"><?php echo $this->escape($company->website) ?></a>
                                                </div>
                                            <?php } ?>
