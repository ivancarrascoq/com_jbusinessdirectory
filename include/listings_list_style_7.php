							...
							<div class="content-box">
								...
								<ul class="company-links">
									...
									<?php if($showData && !empty($company->website) && (isset($company->packageFeatures) && in_array(WEBSITE_ADDRESS,$company->packageFeatures) || !$enablePackages)){
										...
										<li><a <?php echo $followLink ?> class="nowrap" target="_blank" title="<?php echo $company->name?> Website" target="_blank"  onclick="registerAction(<?php echo $company->id ?>,<?php echo STATISTIC_TYPE_WEBSITE_CLICK ?>)"  href="<?php echo $company->website ?>"><i class="dir-icon-globe"></i> <?php echo JText::_('LNG_WEBSITE') ?></a></li>
									<?php } ?>
